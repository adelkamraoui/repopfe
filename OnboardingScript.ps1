...
try {
    ...
    $env:SUBSCRIPTION_ID = "33191694-898b-4492-8f76-7569479c438e";
    $env:RESOURCE_GROUP = "RG-AKAM-Public-STG-TEST";
    $env:TENANT_ID = "757bdf2a-9fe4-43ea-b5c9-fdb554650622";
    $env:LOCATION = "francecentral";
    $env:AUTH_TYPE = "token";
    $env:CORRELATION_ID = "9137fe93-cbaf-4274-a610-e0843d6b521d";
